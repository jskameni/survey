...
class SondageController extends Controller
{
	...
	public function index() 
	{
		...
		return view('index', ['sondages' => $this->sondageGestion->getSondages()]);
	}
	...
	public function create($nom)
	{
		...
		return view('sondage', ['sondage' => $this->sondageGestion->getSondage($nom), 'nom' => $nom]);
	}
	...
	public function store(SondageRequest $request, $nom)
	{
		...
		if($this->sondageGestion->save($nom, $request->all())) 
		{
			...
			return view('resultats', ['sondage' => $this->sondageGestion->getSondage($nom), 'nom' => $nom, 'resultats' => $this->sondageGestion->getResults($nom)]);
		}
